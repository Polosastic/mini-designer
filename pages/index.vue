<template>
   ...
   <div class="flex justify-center">
      <div class="bg-gray-300 basis-1/4 flex flex-col items-center rounded-lg">
        <h2>Colors:</h2>
        <ul>
          <li v-for="color in colors" :key="color.name" class="bg-gray-100 border-gray-400 rounded-lg m-2.5 w-12 h-12 relative">
            <div class="rounded-full w-9 h-9 absolute top-[12%] left-[12%]" :style=" {'background-color': color.color}"></div>
          </li>
        </ul>
      </div>
    ...
    <svg
      ...
      <g
        ...
        <path
            id="rect1"
            style="fill:#93d50a;stroke-width:0.718645"
      ...
      <div class="bg-gray-300 basis-1/4 flex flex-col rounded-lg items-center">
        <h2>Motives:</h2>
        <ul>
